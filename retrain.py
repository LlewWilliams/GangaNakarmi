...
# FLAGS - parameters
tfhub_module_url = 'URL_OF_MODULE'
# --how_many_training_steps "number of training steps" 
# --learning_rate "learning rate" 
# --output_labels "output file containing labels" 
# --output_graph "output file containing the retrained model"
# summaries dir - careful this one gets deleted
...
def create_bottleneck_file(bottleneck_path, image_lists, label_name, index,
  ...
  try:
    print('here is the type ', type(image_data))
...
if __name__ == '__main__':
  ...
  # original dbuscombe file was called from command line - modifying here to run in VS 
  #FLAGS.image_dir = image_dir
  #FLAGS.summaries_dir = summaries_dir
  FLAGS.tfhub_module = tfhub_module_url
  FLAGS.how_many_training_steps = 1000 
  FLAGS.learning_rate = 0.01 
  FLAGS.output_labels = 'LABELS.txt'
  FLAGS.output_graph = 'OUTPUT_RETRAINED_MODEL.pb'
  tf.compat.v1.app.run(main=main, argv=[sys.argv[0]] + unparsed)
  # EXAMPLE FROM DBUSCOMBE
  #python retrain.py 
  # --image_dir "name of directory containing subfolders with image tiles" \
